...
<article class="pt-[120px] pb-24 max-w-3xl mx-auto px-6 prose prose-slate">
    ...
    <h2>1. Aceptación</h2>
    <p>El uso de TurneroYa (la "Plataforma"), operada desde la República Argentina, implica la aceptación de los siguientes términos. Si no estás de acuerdo, no utilices el servicio.</p>

    <h2>2. Servicio</h2>
    <p>TurneroYa ofrece una plataforma SaaS para gestión de turnos, calendario, comunicación por WhatsApp (mediante integración con Twilio), cobros (MercadoPago) y analytics. El servicio se presta "como está" y puede modificarse con aviso previo.</p>
    ...
    <h2>5. Facturación</h2>
    <p>TurneroYa emite factura fiscal conforme a la normativa de AFIP (Argentina) al correo de facturación registrado por el cliente.</p>
    ...
    <p>El titular de la cuenta (negocio) es el responsable del tratamiento de los datos de sus clientes finales. TurneroYa actúa como encargado del tratamiento, procesando esos datos únicamente para prestar el servicio contratado, en los términos de la Ley 25.326 de Protección de Datos Personales.</p>
    ...
    <p>TurneroYa no será responsable por daños indirectos, lucro cesante, pérdida de datos o interrupciones ajenas a nuestro control (proveedores de WhatsApp, MercadoPago, hosting). La responsabilidad máxima acumulada no excederá el monto pagado por el cliente en los últimos 3 meses.</p>
    ...
    <h2>12. Contacto</h2>
    <p>Para consultas: <a href="mailto:legal@turneroya.app">legal@turneroya.app</a></p>
</article>
